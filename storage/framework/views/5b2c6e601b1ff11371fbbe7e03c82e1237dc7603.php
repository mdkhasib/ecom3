                        ...
                        <div>
                            <div class="text-center ">
                                <a href="<?php echo e(route('category', $value->slug)); ?>">
                                    <img class="" src="<?php echo e(asset($value->image)); ?>" alt="" style="border: 2px solid #4c9b82; border-radius: 50%; width: 100%; height: auto;" />
                                </a>
                            </div>
                            <div class="text-center">
                                <a href="<?php echo e(route('category', $value->slug)); ?>">
...
<?php echo $__env->make('frontEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/pro/eazytech/ecom/ecommerce3/resources/views/frontEnd/layouts/pages/index.blade.php ENDPATH**/ ?>