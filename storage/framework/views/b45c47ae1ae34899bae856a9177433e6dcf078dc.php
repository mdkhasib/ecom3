...
<html lang="en">
    <head>
        ...
        <meta name="author" content="Khairul Hasib" />
    ...
    <body class="gotop">
        ...
        <header id="navbar_top">
            <div class="top_header" style="background-color:#4c9b82">
            ...
            <div class="main-header">
                ...
                <div class="menu-area">
                    <div class="container">
                        ...
                        <nav class="raw-navbar" aria-label="Primary">
                            <div class="nav-inner">
                                <!-- Logo / Brand -->
                                ...
                                <!-- Menu -->
                                <ul id="primaryMenu" class="nav-menu" role="menubar">
                                    <!-- Home -->
                                    <li class="nav-item" role="none">
                                        <a class="nav-link" role="menuitem" href="<?php echo e(url('/')); ?>">Home</a>
                                    </li>

                                    <!-- Categories (dynamic multi-level) -->
                                    <li class="nav-item has-dropdown" role="none">
                                        <button class="nav-link dropdown-toggle" aria-haspopup="true" aria-expanded="false">
                                            Categories
                                        </button>

                                        <ul class="dropdown" role="menu" aria-label="Categories">
                                            <?php $__currentLoopData = $menucategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $scategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li class="dropdown-item has-dropdown" role="none">
                                                    <a class="dropdown-link" role="menuitem" href="<?php echo e(url('category/' . $scategory->slug)); ?>">
                                                        <?php echo e($scategory->name); ?>

                                                    </a>

                                                    <?php if($scategory->subcategories->count() > 0): ?>
                                                        <button class="sub-toggle" aria-haspopup="true" aria-expanded="false" aria-label="Open subcategories">
                                                            ▶
                                                        </button>

                                                        <ul class="dropdown nested" role="menu" aria-label="<?php echo e($scategory->name); ?> subcategories">
                                                            <?php $__currentLoopData = $scategory->subcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <li class="dropdown-item has-dropdown" role="none">
                                                                    <a class="dropdown-link" role="menuitem" href="<?php echo e(url('subcategory/' . $subcat->slug)); ?>">
                                                                        <?php echo e(Str::limit($subcat->subcategoryName, 25)); ?>

                                                                    </a>

                                                                    <?php if($subcat->childcategories->count() > 0): ?>
                                                                        <button class="sub-toggle" aria-haspopup="true" aria-expanded="false" aria-label="Open childcategories">
                                                                            ▶
                                                                        </button>

                                                                        <ul class="dropdown nested" role="menu" aria-label="<?php echo e($subcat->subcategoryName); ?> childcategories">
                                                                            <?php $__currentLoopData = $subcat->childcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $childcat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                <li class="dropdown-item" role="none">
                                                                                    <a class="dropdown-link" role="menuitem" href="<?php echo e(url('products/' . $childcat->slug)); ?>">
                                    ...
                                    <!-- Static pages -->
                                    <li class="nav-item" role="none"><a class="nav-link" role="menuitem" href="<?php echo e(url('/page/privacy-policy')); ?>">Privacy Policy</a></li>
                                    <li class="nav-item" role="none"><a class="nav-link" role="menuitem" href="<?php echo e(url('/page/return-policy')); ?>">Return Policy</a></li>
                                    <li class="nav-item" role="none"><a class="nav-link" role="menuitem" href="<?php echo e(url('/page/terms-&-conditions')); ?>">Terms &amp; Conditions</a></li>
                                    <li class="nav-item" role="none"><a class="nav-link" role="menuitem" href="<?php echo e(url('/page/about-us')); ?>">About Us</a></li>
                                </ul>
                            </div>
                        </nav>

                        <!-- Minimal styles for the raw navbar -->
                        <style>
                        /* Basic layout */
                        .raw-navbar { background:#22b591; border-bottom:1px solid #e6e6e6; font-family:system-ui, -apple-system, "Segoe UI", Roboto, "Helvetica Neue", Arial; }
                        .nav-inner { max-width:1200px; margin:0 auto; display:flex; align-items:center; justify-content:space-between; padding:0.5rem 1rem; }
                        .brand { font-weight:700; text-decoration:none; color:#111; margin-right:1rem; }

                        /* Toggler (mobile) */
                        .nav-toggle { display:none; background:transparent; border:0; font-size:1.25rem; cursor:pointer; }

                        /* Menu (desktop LTR) */
                        .nav-menu { list-style:none; margin:0; padding:0; display:flex; align-items:center; gap:0.5rem; }
                        .nav-item { position:relative; }
                        .nav-link, .dropdown-link, .dropdown-toggle { display:inline-flex; align-items:center; padding:0.5rem 0.75rem; text-decoration:none; color:#222; background:transparent; border:0; cursor:pointer; font-size:0.95rem; }
                        .nav-link:hover, .dropdown-link:hover, .dropdown-toggle:hover { background:#f5f5f5; border-radius:4px; }

                        /* Dropdowns */
                        .dropdown { position:absolute; left:0; top:100%; min-width:220px; background:#fff; border:1px solid #ddd; box-shadow:0 6px 18px rgba(0,0,0,0.06); padding:0.25rem 0; display:none; z-index:2000; }
                        .dropdown.nested { left:100%; top:0; margin-left:6px; }

                        /* Items inside dropdown */
                        .dropdown-item { white-space:nowrap; display:flex; align-items:center; justify-content:space-between; position:relative; }
                        .dropdown-link { padding:0.5rem 0.75rem; width:100%; text-align:left; color:#222; }

                        /* little toggles for nested menus */
                        .sub-toggle { background:transparent; border:0; padding:0.5rem; cursor:pointer; font-size:0.85rem; color:#666; }

                        /* show dropdown when .open applied */
                        ...
                        @media (max-width: 900px) {
                            ...
                            .nav-menu { position:fixed; top:56px; right:0; left:0; background:#fff; flex-direction:column; align-items:flex-start; padding:0.5rem 1rem; gap:0; max-height:0; overflow:hidden; transition:max-height .22s ease; z-index:1500; border-top:1px solid #eee; }
                            .nav-menu.open { max-height:80vh; overflow:auto; }
                            .nav-link, .dropdown-link { width:100%; }
                            .dropdown { position:relative; left:auto; top:auto; box-shadow:none; border:0; padding-left:0.5rem; display:none; }
                            .dropdown.nested { margin-left:0.5rem; }
                            .has-dropdown.open > .dropdown { display:block; }
                        }
                        .sr-only { position:absolute; width:1px; height:1px; padding:0; margin:-1px; overflow:hidden; clip:rect(0,0,0,0); border:0; }
                        </style>

                        <!-- Minimal JS: toggles menu and nested dropdowns; no library dependency -->
                        <script>
                        (function(){
                            // Elements
                            ...
                            // Toggle dropdowns on click (works for mobile and desktop click)
                            document.querySelectorAll('.has-dropdown > .dropdown-toggle, .has-dropdown > .dropdown-link + .sub-toggle, .has-dropdown > .sub-toggle').forEach(btn=>{
                                btn.addEventListener('click', function(e){
                                    // find the parent LI with has-dropdown
                                    ...
                                    if(parentList){
                                        parentList.querySelectorAll(':scope > .has-dropdown.open').forEach(sib=>{
                            ...
                            document.addEventListener('click', function(e){
                                const insideNav = e.target.closest('.raw-navbar');
                                if(!insideNav){
                                    // close mobile menu
                            ...
                            // Desktop: open top-level dropdown on hover (optional)
                            ...
                            function setHoverBehavior() {
                                document.querySelectorAll('.nav-item.has-dropdown').forEach(li=>{
                                    ...
                                    if(mq.matches){
                                        li.onmouseenter = () => li.classList.add('open');
                                        li.onmouseleave = () => li.classList.remove('open');
                                    }
                                });
                            }
                            setHoverBehavior();
                            mq.addListener(setHoverBehavior);

                            // keyboard accessibility: allow Esc to close open menus
            ...
            <div class="footer-bottom">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="copyright">
                                <p>Copyright © <?php echo e(date('Y')); ?> <?php echo e($generalsetting->name); ?>. All rights reserved | <span style="color: white;">Website Designed by: <a href="https://findmycard.xyz/khairul"><span style="color: white;">Khairul Hasib</span></a></span></p>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php /**PATH /opt/lampp/htdocs/pro/eazytech/ecom/ecommerce3/resources/views/frontEnd/layouts/master.blade.php ENDPATH**/ ?>