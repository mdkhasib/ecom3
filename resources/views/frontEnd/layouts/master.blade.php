                ...
                <div class="menu-area">
                    <div class="container">
                        ...
                        <nav class="raw-navbar" aria-label="Primary">
                            <div class="nav-inner">
                                <!-- Logo / Brand -->
                                {{-- <a class="brand" href="{{ url('/') }}">MyShop</a> --}}
                                ...
                                <ul id="primaryMenu" class="nav-menu" role="menubar">
                                    ...
                                    <li class="nav-item" role="none">
                                        <a class="nav-link" role="menuitem" href="{{ url('/') }}">Home</a>
                                    </li>
                                        ...
                                        <ul class="dropdown" role="menu" aria-label="Categories">
                                            @foreach ($menucategories as $scategory)
                                                <li class="dropdown-item has-dropdown" role="none">
                                                    <a class="dropdown-link" role="menuitem" href="{{ url('category/' . $scategory->slug) }}">
                                                        {{ $scategory->name }}
                                                    </a>
                                                    ...
                                                    @if ($scategory->subcategories->count() > 0)
                                                        ...
                                                        <ul class="dropdown nested" role="menu" aria-label="{{ $scategory->name }} subcategories">
                                                            @foreach ($scategory->subcategories as $subcat)
                                                                <li class="dropdown-item has-dropdown" role="none">
                                                                    <a class="dropdown-link" role="menuitem" href="{{ url('subcategory/' . $subcat->slug) }}">
                                                                    ...
                                                                    @if ($subcat->childcategories->count() > 0)
                                                                        ...
                                                                        <ul class="dropdown nested" role="menu" aria-label="{{ $subcat->subcategoryName }} childcategories">
                                                                            @foreach ($subcat->childcategories as $childcat)
                                                                                <li class="dropdown-item" role="none">
                                                                                    <a class="dropdown-link" role="menuitem" href="{{ url('products/' . $childcat->slug) }}">
                                    ...
                                    <!-- Static pages -->
                                    <li class="nav-item" role="none"><a class="nav-link" role="menuitem" href="{{ url('/page/privacy-policy') }}">Privacy Policy</a></li>
                                    <li class="nav-item" role="none"><a class="nav-link" role="menuitem" href="{{ url('/page/return-policy') }}">Return Policy</a></li>
                                    <li class="nav-item" role="none"><a class="nav-link" role="menuitem" href="{{ url('/page/terms-&-conditions') }}">Terms &amp; Conditions</a></li>
                                    <li class="nav-item" role="none"><a class="nav-link" role="menuitem" href="{{ url('/page/about-us') }}">About Us</a></li>
                                </ul>
                            </div>
                        </nav>
            ...
            <div class="footer-bottom">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="copyright">
                                <p>Copyright © {{ date('Y') }} {{$generalsetting->name}}. All rights reserved | <span style="color: white;">Website Designed by: <a href="https://findmycard.xyz/khairul"><span style="color: white;">Khairul Hasib</span></a></span></p>
                            </div>
                        </div>
                    </div>
                </div>
